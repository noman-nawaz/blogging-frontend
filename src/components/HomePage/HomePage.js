...
import poster1 from "../../img/poster3.png"
        ...
        <div className="relative container px-4   mx-auto">
          <div className="flex flex-wrap items-center -mx-4 mb-10 2xl:mb-14">
            <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
              <span className="text-xl 2xl:mb-24 font-bold text-blue-400">
                Welcome to Blogging
              </span>
              ...
              <p className="mb-12 lg:mb-16 2xl:mb-24 text-xl text-gray-100">
                Your blog must be free from racism and unhealthy words
              </p>
              <a
            ...
            <div className="w-full lg:w-1/2 px-4">
              <img className="w-full" src={poster1} alt={poster1} />
            </div>
          </div>
        </div>
      </section>
